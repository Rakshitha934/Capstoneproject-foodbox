...
import { ɵNgNoValidate, DefaultValueAccessor } from '@angular/forms';
  ...
  sortData(sort: Sort) {
    ...
    this.sortedProd = data.sort((a, b) => {
      ...
      switch (sort.active) {
        ...
        case 'actualPrice':
          return this.compare(a.actualPrice, b.actualPrice, isAsc);
        case 'discount':
          return this.compare(a.discount, b.discount, isAsc);
        case 'price':
          return this.compare(a.price, b.price, isAsc);
        case 'avail':
          return this.compare(a.avail, b.avail, isAsc);
        default:
          return 0; // Default case when sort.active doesn't match any cases
      }
    });
  }
